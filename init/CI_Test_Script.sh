...
tg_sendinfo "<code>I am gonna merge staging into TG-Lonwolf</code>"
cd
...
git push --force origin staging:TG-Lonwolf
tg_sendinfo "<code>I have merged all commits from staging into TG-Lonwolf</code>"
