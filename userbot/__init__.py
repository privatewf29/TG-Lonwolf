...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL",
    "https://github.com/W29F/TG-Lonwolf.git")
UPSTREAM_REPO_BRANCH = os.environ.get(
    "UPSTREAM_REPO_BRANCH", "TG-Lonwolf")
...
async def check_alive():
    await bot.send_message(BOTLOG_CHATID, "```☙✘♥ TG-Lonwolf Berhasil Di Aktifkan ♥✘❧```")
    return
    ...
    try:
        ...
        async def handler(event):
            if event.message.from_id != uid:
                await event.reply("Deploy Userbot Mu Sendiri [Tekan Disini](https://github.com/W29F/TG-Lonwolf.git)")
            else:
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith("@UserButt"):
                ...
                result = builder.article(
                    ...
                    text="{}\n\n**❧ Jumlah Module Yang Tersedia :** `{}`\n               \n**❧ Daftar Modul TG-Lonwolf :** \n".format(
                        "**☙ TG-Lonwolf Main Menu ❧**",
                        len(dugmeler),
                    ),
                    buttons=buttons,
                    link_preview=False,
                ...
                result = builder.article(
                    "**✗ TG-Lonwolf ✗**",
                    text="""**Buat Userbot Anda Sendiri Dengan Cara :** [Tekan Disini](https://github.com/W29F/TG-Lonwolf)""",
                    buttons=[
                        [
                            custom.Button.url(
                                "Repo TG-Lonwolf",
                                "https://github.com/W29F/TG-Lonwolf"),
                            custom.Button.url(
                                "Owner Repo",
                                "t.me/privatener")],
                    ],
