...
async def killdabot(event):
    await event.edit("`Restarting TG-Lonwolf...`")
    await asyncio.sleep(10)
    await event.delete()
    if BOTLOG:
        await event.client.send_message(
            BOTLOG_CHATID, "#RESTARTBOT \n" "`TG-Lonwolf Telah Di Restart`"
        )
    await bot.disconnect()
...
async def reedme(e):
    await e.edit(
        ...
        "\n[Userbot Repo](https://github.com/W29F/TG-Lonwolf/blob/TG-LoneUbot/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        f"**Hey**, __I am using__ ♥ **TG-Lonwolf** ♥\n\n"
        f"      __Thanks For Using me__\n\n"
        f"ღ **Userbot Version :** `4.1@TG-Lonwolf`\n"
        f"ღ **Group Support :** [Sharing Userbot](t.me/privatener)\n"
        f"ღ **Owner Repo :** [NerSup](t.me/privatener)\n"
        f"ღ **Repo :** [TG-Lonwolf](https://github.com/W29F/TG-Lonwolf)\n"
    )
...
CMD_HELP.update(
    {
        "repo": "**Plugin : **`Repository TG-Lonwolf`\
        \n\n  •  **Syntax :** `.repo`\
        \n  •  **Function : **Menampilan link Repository TG-Lonwolf\
        \n\n  •  **Syntax :** `.string`\
        \n  •  **Function : **Menampilan link String TG-Lonwolf\
    "
    }
)
