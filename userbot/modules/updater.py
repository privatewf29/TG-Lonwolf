...
async def update(event, repo, ups_rem, ac_br):
    ...
    await event.edit("**❧ TG-Lonwolf** `Berhasil Di Update!`")
    await asyncio.sleep(1)
    await event.edit("**❧ TG-Lonwolf** `Sedang di Restart....`")
    await asyncio.sleep(1)
...
async def upstream(event):
    ...
    if changelog == "" and force_update is False:
        await event.edit(f"\n**❧ TG-Lonwolf Sudah Versi Terbaru**\n")
        await asyncio.sleep(15)
        await event.delete()
        return repo.__del__()

    if conf is None and force_update is False:
        changelog_str = f"**❧ Pembaruan Untuk TG-Lonwolf [{ac_br}] :\n\n✥ Pembaruan:**\n`{changelog}`"
        ...
        return await event.respond(
            "❧ **Perintah Untuk Update TG-Lonwolf**\n >`.update now`\n >`.update deploy`\n\n__Untuk Meng Update Fitur Terbaru Dari TG-Lonwolf__"
        )
    ...
    if force_update:
        ...
        await event.edit("`❧ Proses Update TG-Lonwolf, Loading....1%`")
        await event.edit("`❧ Proses Update TG-Lonwolf, Loading....12%`")
        await event.edit("`❧ Proses Update TG-Lonwolf, Loading....25%`")
        await event.edit("`❧ Proses Update TG-Lonwolf, Loading....46%`")
        await event.edit("`❧ Proses Update TG-Lonwolf, Loading....76%`")
        await event.edit("`❧ Proses Update TG-Lonwolf, Updating...92%`")
        await event.edit("`❧ Proses Update TG-Lonwolf, Tunggu Sebentar....100%`")
    if conf == "now":
